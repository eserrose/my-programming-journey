...
int main(int argc, string argv[])
{
        ...
        int key, j = 0, lenght = strlen(argv[1]);
        for(int i = 0, n = strlen(p); i < n; i++)
        {
            if(isalpha(p[i]))
            {

                if(isupper(argv[1][j % lenght]) && isalpha(argv[1][j % lenght]))
                {
                   key = argv[1][j % lenght] - 'A';
                }

                if(islower(argv[1][j % lenght]) && isalpha(argv[1][j % lenght]))
                {
                   key = argv[1][j % lenght] - 'a';
                }
