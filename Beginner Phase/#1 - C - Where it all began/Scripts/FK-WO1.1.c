...
float progress_2(int *);
int main()
{

printf("Welcome to the Firat Kervan Workout Program v1.1\n");
...
printf("20xSquats (Bw)\n");
printf("How many did you do?: "); scanf("%d",&moves[0]);
puts("");
printf("15xPush-Ups\n");
printf("How many did you do?: "); scanf("%d",&moves[1]);
puts("");
printf("10xLunge (Each Leg)\n");
printf("How many did you do?: "); scanf("%d",&moves[2]);
puts("");
printf("30 Sec Plank\n");
printf("How many seconds did you do?: "); scanf("%d",&moves[3]);
puts("");
printf("20xJumping Jacks\n");
printf("How many did you do?: "); scanf("%d",&moves[4]);
puts("");
printf("15xHip Thrusts\n");
printf("How many did you do?: "); scanf("%d",&moves[5]);
puts("");
printf("15xInclined Push-Ups\n");
printf("How many did you do?: "); scanf("%d",&moves[6]);
puts("");
printf("25xCrunches\n");
printf("How many did you do?: "); scanf("%d",&moves[7]);
puts("");
printf("10xBench Dips\n");
printf("How many did you do?: "); scanf("%d",&moves[8]);
r++;
if(r<3){
